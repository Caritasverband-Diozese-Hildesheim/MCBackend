...
export default {
    getAllAtachment: (req, res, next) => {
        apiUse.get('https://dicvhi.atlassian.net/wiki/rest/api/content/152403969/child/attachment', { "Authorization": "Basic " + Buffer.from(configuration.DMSUserEmail + ":" + configuration.DMSAPIToken).toString('base64') }, (statusCode, data) => {
            if (statusCode == 200) {
