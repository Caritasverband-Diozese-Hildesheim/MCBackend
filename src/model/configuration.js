...
* @property {!string|"has to be URL"} baseUrl Root URL of the app. <strong>Automatically generated from scheme, host, port</strong>
...
* @property {!string|"has to be URL"} OIDCAuthUrl Root URL of the OID Server. <strong>MUST be set with environment variable</strong>
